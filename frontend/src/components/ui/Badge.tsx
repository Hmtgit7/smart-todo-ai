  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        priority: {
          low: "border-transparent bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400",
          medium:
            "border-transparent bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-400",
          high: "border-transparent bg-orange-100 text-orange-800 dark:bg-orange-900/20 dark:text-orange-400",
          urgent:
